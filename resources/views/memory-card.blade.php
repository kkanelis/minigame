...
<div style="background: #0a0a0a; min-height: 100vh; color: white; padding: 0;">
    ...
    <div style="padding: 40px; max-width: 800px; margin: 0 auto;">
        ...
        <!-- Setup Section -->
        <div style="background: #1a1a1a; border: 1px solid #333; padding: 30px; border-radius: 12px; margin-bottom: 30px;">
            <div style="display: grid; grid-template-columns: 1fr 1fr 1fr; gap: 30px;">
                ...
                <div>
                    ...
                    <div style="display: flex; flex-direction: column; gap: 10px;">
                        <button class="difficulty-btn" data-difficulty="easy" data-cols="2" data-rows="2" style="padding: 12px; border: 2px solid #333; border-radius: 4px; cursor: pointer; background: transparent; color: white; font-weight: bold; transition: all 0.3s;">
                            Easy (2x2)
                        </button>
                        <button class="difficulty-btn" data-difficulty="medium" data-cols="3" data-rows="4" style="padding: 12px; border: 2px solid #333; border-radius: 4px; cursor: pointer; background: transparent; color: white; font-weight: bold; transition: all 0.3s;">
                            Medium (3x4)
                        </button>
                        <button class="difficulty-btn" data-difficulty="hard" data-cols="4" data-rows="5" style="padding: 12px; border: 2px solid #333; border-radius: 4px; cursor: pointer; background: transparent; color: white; font-weight: bold; transition: all 0.3s;">
                            Hard (4x5)
                        </button>
                        <button class="difficulty-btn" data-difficulty="extreme" data-cols="6" data-rows="7" style="padding: 12px; border: 2px solid #333; border-radius: 4px; cursor: pointer; background: transparent; color: white; font-weight: bold; transition: all 0.3s;">
                            EXTREME 😡 (6x7)
                        </button>
                    </div>
                </div>
                ...
                <!-- Player Name -->
                <div>
                    <label style="display: block; margin-bottom: 15px; font-weight: bold; font-size: 14px; color: #999; text-transform: uppercase;">Player Name</label>
                    <input id="playerNameInput" type="text" maxlength="30" style="width: 100%; padding: 12px; border: 1px solid #333; border-radius: 4px; background: #0a0a0a; color: white; font-size: 14px; box-sizing: border-box;" placeholder="Enter your name">
                </div>

                <!-- Start Button -->
                <div style="display: flex; align-items: flex-end;">
                    <button id="startBtn" style="width: 100%; padding: 12px; background: white; color: #000; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; font-size: 16px;">Start Game</button>
                </div>
            </div>
        </div>
        ...
        <div style="display: grid; grid-template-columns: repeat(4, 1fr); gap: 20px; margin-bottom: 30px;">
            <div style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 12px; text-align: center;">
        ...
        <!-- Game Board -->
        <div style="background: #1a1a1a; border: 1px solid #333; padding: 100px; border-radius: 12px; text-align: center;">
        ...
        <!-- Game Over Modal -->
        <div id="gameOverModal" style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.8); align-items: center; justify-content: center; z-index: 1000;">
            <div style="background: #1a1a1a; border: 1px solid #333; padding: 40px; border-radius: 12px; text-align: center; max-width: 400px;">
                ...
                <button onclick="location.reload()" style="width: 100%; padding: 12px; background: white; color: #000; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; font-size: 16px; margin-top: 20px;">Play Again</button>
