    ...
    <div style="padding: 40px; max-width: 1200px; margin: 0 auto;">
        ...
        <div style="margin-bottom: 60px;">
            ...
            <div style="display: flex; gap: 10px; margin-bottom: 20px;">
                <button class="typing-tab" data-difficulty="easy" style="padding: 10px 20px; border: 1px solid #333; background: #0066cc; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Easy</button>
                <button class="typing-tab" data-difficulty="medium" style="padding: 10px 20px; border: 1px solid #333; background: transparent; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Medium</button>
                <button class="typing-tab" data-difficulty="hard" style="padding: 10px 20px; border: 1px solid #333; background: transparent; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Hard</button>
                <button class="typing-tab" data-difficulty="hardcore" style="padding: 10px 20px; border: 1px solid #333; background: transparent; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Hardcore</button>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="border-bottom: 1px solid #333; background: #0a0a0a;">
                            <th style="padding: 15px; text-align: left; font-size: 12px; color: #999; text-transform: uppercase;">Rank</th>
                            <th style="padding: 15px; text-align: left; font-size: 12px; color: #999; text-transform: uppercase;">Player</th>
                            <th style="padding: 15px; text-align: center; font-size: 12px; color: #999; text-transform: uppercase;">WPM</th>
                            <th style="padding: 15px; text-align: center; font-size: 12px; color: #999; text-transform: uppercase;">Accuracy</th>
                            <th style="padding: 15px; text-align: center; font-size: 12px; color: #999; text-transform: uppercase;">Time</th>
                        </tr>
                    </thead>
                    <tbody id="typing-easy-body">
                        <tr style="text-align: center; color: #666;"><td colspan="5" style="padding: 40px;">Loading...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
        ...
        <div>
            ...
            <div style="display: flex; gap: 10px; margin-bottom: 20px;">
                <button class="memory-tab" data-difficulty="easy" style="padding: 10px 20px; border: 1px solid #333; background: #0066cc; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Easy (2x2)</button>
                <button class="memory-tab" data-difficulty="medium" style="padding: 10px 20px; border: 1px solid #333; background: transparent; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Medium (3x4)</button>
                <button class="memory-tab" data-difficulty="hard" style="padding: 10px 20px; border: 1px solid #333; background: transparent; color: white; border-radius: 4px; cursor: pointer; font-weight: bold;">Hard (4x5)</button>
            </div>
                ...
                <table style="width: 100%; border-collapse: collapse;">
                    <thead>
                        <tr style="border-bottom: 1px solid #333; background: #0a0a0a;">
                            <th style="padding: 15px; text-align: left; font-size: 12px; color: #999; text-transform: uppercase;">Rank</th>
                            <th style="padding: 15px; text-align: left; font-size: 12px; color: #999; text-transform: uppercase;">Player</th>
                            <th style="padding: 15px; text-align: center; font-size: 12px; color: #999; text-transform: uppercase;">Time (s)</th>
                            <th style="padding: 15px; text-align: center; font-size: 12px; color: #999; text-transform: uppercase;">Moves</th>
                        </tr>
                    </thead>
                    <tbody id="memory-easy-body">
                        <tr style="text-align: center; color: #666;"><td colspan="4" style="padding: 40px;">Loading...</td></tr>
                    </tbody>
                </table>
            </div>
        </div>
