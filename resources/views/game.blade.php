        ...
        <div style="padding: 40px; max-width: 1200px; margin: 0 auto;">
            ...
            <div style="display: grid; grid-template-columns: 300px 1fr; gap: 40px;">
                ...
                <div>
                    <!-- Settings -->
                    <div
                        style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 12px; margin-bottom: 20px;">
                        <label
                        ...
                        <select id="difficulty"
                            style="width: 100%; padding: 10px; background: #0a0a0a; color: white; border: 1px solid #333; border-radius: 4px; margin-bottom: 20px;">
                    ...
                    <div style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 12px;">
                        ...
                        <div style="margin-bottom: 20px; text-align: center;">
                            <p style="margin: 0 0 10px 0; font-size: 12px; color: #999; text-transform: uppercase;">Accuracy
                            </p>
                ...
                <div>
                    <!-- Target Text -->
                    <div
                        style="background: #1a1a1a; border: 1px solid #333; padding: 30px; border-radius: 12px; margin-bottom: 10px;">
                    ...
                    <div style="background: #1a1a1a; border: 1px solid #333; padding: 20px; border-radius: 12px;">
                        <textarea id="gameInput"
                            style="width: 100%; height: 120px; background: #0a0a0a; color: white; border: 1px solid #444; border-radius: 4px; padding: 15px; font-size: 16px; font-family: monospace; resize: none;"
                            placeholder="Start typing here..."></textarea>
                        <button onclick="resetGame()"
                            style="width: 100%; padding: 12px; background: #666; color: white; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; margin-top: 10px;">Reset</button>
                    </div>
                </div>
            </div>
            ...
            <div id="gameOverModal"
                style="display: none; position: fixed; top: 0; left: 0; right: 0; bottom: 0; background: rgba(0,0,0,0.9); align-items: center; justify-content: center; z-index: 1000;">
                <div
                    style="background: #1a1a1a; border: 1px solid #333; padding: 40px; border-radius: 12px; text-align: center; max-width: 500px;">
                    ...
                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 20px; margin: 30px 0;">
                        ...
                        <div>
                            <p style="color: #999; margin: 10px 0; font-size: 14px; text-transform: uppercase;">Difficulty
                            </p>
                            <p id="finalDifficulty"
                                style="margin: 10px 0; font-size: 28px; font-weight: bold; text-transform: capitalize;">-
                            </p>
                        </div>
                    </div>
                    <button onclick="resetGame()"
                        style="width: 100%; padding: 12px; background: white; color: #000; border: none; border-radius: 4px; font-weight: bold; cursor: pointer; margin-top: 20px;">Play
                        Again</button>
                    <a href="/"
    ...
    <script>
        ...
        function endGame() {
            ...
            fetch('/api/game-result', {
                ...
                body: JSON.stringify({
                    nickname: sessionStorage.getItem('playerName') || 'Anonymous',
