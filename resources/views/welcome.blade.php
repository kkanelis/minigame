...
@section('content')
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div class="text-center mb-20">
            ...
            <p class="text-xl text-slate-400 mb-8 max-w-2xl mx-auto">Jautras un interesantas interneta spēles. Spēlē uzreiz,
                bez nekādām lejuplādēm.</p>
        </div>
        ...
        <div class="mb-20">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 md:gap-6">
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-lg p-6 hover:border-blue-500 transition-all">
                    ...
                    <a href="/memory"
                        class="w-full py-2 bg-blue-600 hover:bg-blue-700 text-white rounded transition-all block text-center">Spēlēt
                        tagad</a>
                </div>
                ...
                <div class="bg-slate-800 border border-slate-700 rounded-lg p-6 hover:border-purple-500 transition-all">
                    ...
                    <a href="/game"
                        class="w-full py-2 bg-purple-600 hover:bg-purple-700 text-white rounded transition-all block text-center">Spēlēt
                        tagad</a>
                </div>
            </div>
        </div>
